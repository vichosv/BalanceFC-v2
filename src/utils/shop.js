...
export const DEFAULT_SHOP_ITEMS = [
  ...
  { id:'title_challenger',  category:'title', name:'Challenger',   emoji:'🥊', price:4,  desc:'Vas por todo' },
  { id:'title_contender',   category:'title', name:'Contender',    emoji:'🎯', price:5,  desc:'Candidato serio' },
  { id:'title_competitor',  category:'title', name:'Competitor',   emoji:'🏁', price:5,  desc:'Nunca aflojás' },
  { id:'title_threat',      category:'title', name:'Threat',       emoji:'⚡', price:6,  desc:'Peligro constante' },
  { id:'title_nemesis',     category:'title', name:'Nemesis',      emoji:'😈', price:7,  desc:'La pesadilla del rival' },
  { id:'title_warrior',     category:'title', name:'Warrior',      emoji:'🛡️', price:6,  desc:'Guerrero de cancha' },
  { id:'title_gladiator',   category:'title', name:'Gladiator',    emoji:'🗡️', price:7,  desc:'Pelea cada pelota' },
  { id:'title_champion',    category:'title', name:'Champion',     emoji:'🏆', price:10, desc:'Hecho para ganar' },
  { id:'title_mercenary',   category:'title', name:'Mercenary',    emoji:'💰', price:7,  desc:'Juega por la gloria' },
  { id:'title_ace',         category:'title', name:'Ace',          emoji:'🃏', price:9,  desc:'El as del equipo' },
  { id:'title_clutch',      category:'title', name:'Clutch',       emoji:'🔥', price:9,  desc:'Aparece cuando importa' },
  { id:'title_headhunter',  category:'title', name:'Headhunter',   emoji:'🎯', price:8,  desc:'Precisión letal' },
  { id:'title_marksman',    category:'title', name:'Marksman',     emoji:'🏹', price:7,  desc:'Puntería de élite' },
  { id:'title_sharpshooter',category:'title', name:'Sharpshooter', emoji:'🎯', price:8,  desc:'No falla una' },
  { id:'title_tactician',   category:'title', name:'Tactician',    emoji:'🧠', price:8,  desc:'Lee el juego' },
  { id:'title_strategist',  category:'title', name:'Strategist',   emoji:'♟️', price:8,  desc:'Mente maestra' },
  { id:'title_duelist',     category:'title', name:'Duelist',      emoji:'⚔️', price:7,  desc:'Encara y define' },
  { id:'title_veteran',     category:'title', name:'Veteran',      emoji:'🎖️', price:9,  desc:'Experiencia pura' },
  { id:'title_elite',       category:'title', name:'Elite',        emoji:'💎', price:11, desc:'Por encima del resto' },
  { id:'title_prime',       category:'title', name:'Prime',        emoji:'🌟', price:11, desc:'En su mejor momento' },
  { id:'title_apex',        category:'title', name:'Apex',         emoji:'🔺', price:13, desc:'La cima' },
  { id:'title_predator',    category:'title', name:'Predator',     emoji:'🐆', price:12, desc:'Caza cada error' },
  { id:'title_menace',      category:'title', name:'Menace',       emoji:'☠️', price:10, desc:'Una amenaza andante' },
  { id:'title_goat',        category:'title', name:'The G.O.A.T.', emoji:'🐐', price:15, desc:'El más grande de todos' },
